...
title: "Marka, Warna, dan Wayfinding pada Lantai Transportasi"
slug: "marka-wayfinding-lantai-transportasi"
...
date_modified: null
parent_topic: EPX-11
primary_intent: "Coordinate visual guidance"
reader_community: "Tukang.co.id"
reader_address: "Kawan Tukang.co.id"
final_route: "/artikel/marka-wayfinding-lantai-transportasi.html"
...
# Marka, Warna, dan Wayfinding pada Lantai Transportasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Marka, Warna, dan Wayfinding pada Lantai Transportasi”
...
- **Primary intent:** Coordinate visual guidance
...
- **Scope boundary:** Information design interface; not signage design
- **Final public route:** `/artikel/marka-wayfinding-lantai-transportasi.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Marka, Warna, dan Wayfinding pada Lantai Transportasi**.
...
- `EPX-11-06` → `/artikel/renovasi-lantai-fasilitas-24-jam.html` — Merencanakan Renovasi Lantai pada Fasilitas 24 Jam
...
- **Tie back to this article:** Keep the explanation specific to “Marka, Warna, dan Wayfinding pada Lantai Transportasi”.

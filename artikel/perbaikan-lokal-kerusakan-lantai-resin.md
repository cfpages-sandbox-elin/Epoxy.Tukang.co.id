...
title: "Perbaikan Lokal untuk Gores, Chip, dan Area Terkelupas"
slug: "perbaikan-lokal-kerusakan-lantai-resin"
...
date_modified: null
parent_topic: EPX-13
primary_intent: "Scope spot repair"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/perbaikan-lokal-kerusakan-lantai-resin.html"
...
# Perbaikan Lokal untuk Gores, Chip, dan Area Terkelupas

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Perbaikan Lokal untuk Gores, Chip, dan Area Terkelupas”
...
- **Primary intent:** Scope spot repair
...
- **Scope boundary:** Repair decision; no hazardous application tutorial
- **Final public route:** `/artikel/perbaikan-lokal-kerusakan-lantai-resin.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Perbaikan Lokal untuk Gores, Chip, dan Area Terkelupas**.
...
- `EPX-13-03` → `/artikel/inspeksi-berkala-lantai-industri.html` — Inspeksi Berkala untuk Lantai Pabrik dan Gudang
- `EPX-13-05` → `/artikel/kapan-lantai-epoxy-perlu-recoating.html` — Kapan Lantai Epoxy Perlu Recoating?
- `EPX-13-06` → `/artikel/riwayat-perawatan-lantai-resin.html` — Menyimpan Riwayat Perawatan dan Perbaikan Lantai
...
- **Tie back to this article:** Keep the explanation specific to “Perbaikan Lokal untuk Gores, Chip, dan Area Terkelupas”.

...
title: "Epoxy Tidak Kering atau Lengket: Checklist Investigasi"
slug: "epoxy-tidak-kering-atau-lengket"
description: "Inspect work stages and diagnose bubbles, peeling, pinholes, colour, and cure problems"
status: outline
publication_date: "2026-05-26"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-12
primary_intent: "Triage cure failure"
reader_community: "Tukang.co.id"
reader_address: "Sobat Tukang.co.id"
final_route: "/artikel/epoxy-tidak-kering-atau-lengket.html"
...
# Epoxy Tidak Kering atau Lengket: Checklist Investigasi

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Epoxy Tidak Kering atau Lengket: Checklist Investigasi”
- **Reader and situation:** Inspect work stages and diagnose bubbles, peeling, pinholes, colour, and cure problems
- **Reader outcome:** Inspect work stages and diagnose bubbles, peeling, pinholes, colour, and cure problems
- **Primary intent:** Triage cure failure
...
- **Scope boundary:** Investigation only; hazardous handling excluded
- **Final public route:** `/artikel/epoxy-tidak-kering-atau-lengket.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Epoxy Tidak Kering atau Lengket: Checklist Investigasi**.
...
- `EPX-12-01` → `/artikel/penyebab-epoxy-mengelupas.html` — Penyebab Epoxy Mengelupas dan Cara Menelusuri Akar Masalah
- `EPX-12-02` → `/artikel/gelembung-pinholes-pada-epoxy.html` — Gelembung dan Pinholes pada Epoxy: Sumber dan Pemeriksaan
- `EPX-12-04` → `/artikel/perbedaan-warna-gloss-lantai-epoxy.html` — Perbedaan Warna dan Gloss pada Lantai Epoxy
- `EPX-12-05` → `/artikel/hold-point-inspeksi-sistem-coating.html` — Hold Point Inspeksi dari Substrat sampai Topcoat
...
- **Tie back to this article:** Keep the explanation specific to “Epoxy Tidak Kering atau Lengket: Checklist Investigasi”.

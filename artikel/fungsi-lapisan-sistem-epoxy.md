...
title: "Fungsi Primer, Body Coat, dan Topcoat pada Sistem Epoxy"
...
date_modified: null
parent_topic: EPX-04
primary_intent: "Understand coating build-up"
...
# Fungsi Primer, Body Coat, dan Topcoat pada Sistem Epoxy

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Fungsi Primer, Body Coat, dan Topcoat pada Sistem Epoxy”
...
- **Primary intent:** Understand coating build-up
...
- **Scope boundary:** Layer roles; no brand-specific recipe
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Fungsi Primer, Body Coat, dan Topcoat pada Sistem Epoxy**.
...
- **Tie back to this article:** Keep the explanation specific to “Fungsi Primer, Body Coat, dan Topcoat pada Sistem Epoxy”.

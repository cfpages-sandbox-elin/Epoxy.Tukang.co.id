...
title: "Perbedaan Warna dan Gloss pada Lantai Epoxy"
slug: "perbedaan-warna-gloss-lantai-epoxy"
...
date_modified: null
parent_topic: EPX-12
primary_intent: "Diagnose appearance variance"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/perbedaan-warna-gloss-lantai-epoxy.html"
...
# Perbedaan Warna dan Gloss pada Lantai Epoxy

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Perbedaan Warna dan Gloss pada Lantai Epoxy”
...
- **Primary intent:** Diagnose appearance variance
...
- **Scope boundary:** Appearance only; colour planning is EPX-04
- **Final public route:** `/artikel/perbedaan-warna-gloss-lantai-epoxy.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Perbedaan Warna dan Gloss pada Lantai Epoxy**.
...
- `EPX-12-03` → `/artikel/epoxy-tidak-kering-atau-lengket.html` — Epoxy Tidak Kering atau Lengket: Checklist Investigasi
- `EPX-12-05` → `/artikel/hold-point-inspeksi-sistem-coating.html` — Hold Point Inspeksi dari Substrat sampai Topcoat
- `EPX-12-06` → `/artikel/dokumen-uji-catatan-harian-coating.html` — Dokumen Uji dan Catatan Harian yang Perlu Diminta
...
- **Tie back to this article:** Keep the explanation specific to “Perbedaan Warna dan Gloss pada Lantai Epoxy”.

...
title: "Kontaminasi Oli pada Beton dan Dampaknya pada Daya Lekat"
slug: "kontaminasi-oli-beton-dan-daya-lekat"
description: "Determine whether concrete is ready and identify moisture, contamination, and movement risks"
status: outline
publication_date: "2025-10-09"
publication_date_basis: editorial_backfill
date_modified: null
parent_topic: EPX-02
primary_intent: "Assess oil contamination"
reader_community: "Tukang.co.id"
reader_address: "Teman Tukang.co.id"
final_route: "/artikel/kontaminasi-oli-beton-dan-daya-lekat.html"
...
# Kontaminasi Oli pada Beton dan Dampaknya pada Daya Lekat

## Assignment lock

- **Writer task:** Expand this file into one complete article answering: “Kontaminasi Oli pada Beton dan Dampaknya pada Daya Lekat”
- **Reader and situation:** Determine whether concrete is ready and identify moisture, contamination, and movement risks
- **Reader outcome:** Determine whether concrete is ready and identify moisture, contamination, and movement risks
- **Primary intent:** Assess oil contamination
...
- **Scope boundary:** Contamination diagnosis; cleaning execution is EPX-03
- **Final public route:** `/artikel/kontaminasi-oli-beton-dan-daya-lekat.html`
...
- Start with the concrete decision, confusion, risk, or costly shortcut behind **Kontaminasi Oli pada Beton dan Dampaknya pada Daya Lekat**.
...
- `EPX-02-02` → `/artikel/menilai-kelembapan-beton-sebelum-pelapisan.html` — Cara Menilai Kelembapan Beton Sebelum Pelapisan
- `EPX-02-03` → `/artikel/membaca-retak-beton-sebelum-coating.html` — Membaca Retak Beton: Statis, Bergerak, atau Perlu Investigasi
- `EPX-02-05` → `/artikel/menilai-kekuatan-permukaan-beton.html` — Menilai Kekuatan Permukaan Beton untuk Sistem Resin
- `EPX-02-06` → `/artikel/audit-sambungan-drainase-sebelum-coating.html` — Audit Sambungan, Tepi, Drainase, dan Kemiringan Sebelum Coating
...
- **Tie back to this article:** Keep the explanation specific to “Kontaminasi Oli pada Beton dan Dampaknya pada Daya Lekat”.
